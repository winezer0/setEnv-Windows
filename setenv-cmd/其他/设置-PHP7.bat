...
cd /D %~dp0
echo ==============================
echo 新建 "%Base_Path%\php7" 目录
if not exist "%Base_Path%\php7" mkdir "%Base_Path%\php7"
if exist "%Base_Path%\php7" echo 新建 "%Base_Path%\php7" 目录完成
echo ==============================
echo 配置php7环境变量
echo 追加php7到Path 路径  基于绝对路径  
setenv.exe -a "Path" "%Base_Path%\php7"
echo ==============================
