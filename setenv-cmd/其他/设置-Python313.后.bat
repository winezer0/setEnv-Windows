...
cd /D %~dp0
echo ==============================
echo 新建 "%Base_Path%\python313" 目录
if not exist "%Base_Path%\python313" mkdir "%Base_Path%\python313"
if exist "%Base_Path%\python313" echo 新建 "%Base_Path%\python313" 目录完成
echo ==============================
echo 配置python313环境变量

echo 解决python313兼容性问题
...
echo 追加python313到Path 路径  基于绝对路径  
