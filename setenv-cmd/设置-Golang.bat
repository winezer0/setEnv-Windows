...
echo ==============================
echo 新建 "%Base_Path%\go" 目录
if not exist "%Base_Path%\go" mkdir "%Base_Path%\go"
if exist "%Base_Path%\go" echo 新建 "%Base_Path%\go" 目录完成
echo ==============================
echo 新建 "%Base_Path%\goPath" 目录
if not exist "%Base_Path%\goPath" mkdir "%Base_Path%\goPath"
if exist "%Base_Path%\goPath" echo 新建 "%Base_Path%\goPath" 目录完成
echo ==============================
echo 配置golang环境变量
echo 新建GOROOT
...
echo 追加GOROOT与GOPath到Path 路径  基于绝对路径
